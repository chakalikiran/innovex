...
interface NavbarProps {
  currentTab: 'landing' | 'home' | 'how-it-works' | 'my-clearance' | 'certificate' | 'register';
  setCurrentTab: (tab: 'landing' | 'home' | 'how-it-works' | 'my-clearance' | 'certificate' | 'register') => void;
  onOpenSignIn: () => void;
  onOpenRegister?: () => void;
  onOpenApply: () => void;
...
export function Navbar({ currentTab, setCurrentTab, onOpenSignIn, onOpenRegister, onOpenApply, onOpenAuthority }: NavbarProps) {
          ...
          {studentUser ? (
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-4 sm:px-5 py-2 rounded-full bg-[var(--text-primary)] text-[var(--bg-page)] text-sm font-semibold hover:opacity-90 shadow-xs transition-opacity"
              >
                Register
              </button>
              <button
                ...
                className="px-4 sm:px-5 py-2 rounded-full border border-slate-200 dark:border-slate-700 bg-white dark:bg-transparent text-sm font-medium text-slate-800 dark:text-slate-100 hover:bg-slate-50 dark:hover:bg-slate-800 shadow-xs transition-colors"
              >
                Sign In
              </button>
            </div>
